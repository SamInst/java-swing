...
import org.sam.calendario.component.PanelPopupEditor;
import org.sam.calendario.component.date.*;
...
import org.sam.calendario.event.DateSelectionEvent;
import org.sam.calendario.event.DateSelectionListener;
import org.sam.calendario.swing.slider.PanelSlider;
import org.sam.calendario.swing.slider.SimpleTransition;
...
public class DatePicker extends PanelPopupEditor implements DateSelectionModelListener, DateControlListener, ChangeListener {
    ...
    private final String separator = " to ";
    ...
    private void installEditor(JFormattedTextField editor) {
        if (editor != null) {
            ...
            editorButton = new JButton(editorIcon != null ? editorIcon : new FlatSVGIcon("icones/calendario/calendar.svg", 0.8f));
